...
class ServiceRequestSheet extends ConsumerStatefulWidget {
  const ServiceRequestSheet({required this.details, super.key});
  ...
  Widget _fields() => Column(
    ...
    children: [
      ...
      AppTextField(
        ...
        hint: 'Ex.: interfone, acesso ou detalhe importante',
        minLines: 2,
        maxLines: 4,
        maxLength: 1000,
        enabled: !_form.submitting,
      ),
